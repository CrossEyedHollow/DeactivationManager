...
#Region "Functions"
    ...
    Public Function InsertRawJson(table As String, Json As String, type As String, recallCode As String) As Boolean
        'Generate the query 
        Dim query As String = $"INSERT INTO `{DBName}`.`{table}` (fldJson, fldType, fldLocalCode) VALUES ('{Json}', '{type}', '{recallCode}');"
        'Execute it
